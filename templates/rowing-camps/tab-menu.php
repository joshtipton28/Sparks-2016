	...
	<div class="tabs-content nano has-scrollbar" data-tabs-content="rowing-camp-tabs">
        <div class="nano-content">
            <ul class="tabs" data-tabs id="rowing-camp-tabs">
                <li class="tabs-title is-active"><a href="#camp-overview" aria-selected="true">Camp Overview</a></li>
                <li class="tabs-title">
                    <a href="#camp-staff">
                ...
                <li class="tabs-title"><a href="#camp-details">Details</a></li>
                <li class="tabs-title">
                ...
                if ($programType == 'camp') 
                    echo '<li class="tabs-title"><a href="#camp-schedule">Schedule</a></li>';
                ?>
            </ul>