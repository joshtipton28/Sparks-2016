...
<div class="tabs-wrap medium-4 columns">
  <h3>Working With Us</h3>
      <ul class="tabs vertical">
        <li class="tabs-title"><a href="<?php echo home_url();?>/working-with-us/">College Counseling<i class="fa fa-chevron-right"></i></a></li>
        ...
        <li class="tabs-title"><a href="<?php echo home_url();?>/working-with-us/">Coxswain Testimonials<i class="fa fa-chevron-right"></i></a></li>
      </ul>
</div>